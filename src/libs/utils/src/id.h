...
public:
    ...
    friend UTILS_LIBRARY_EXPORT QDataStream &operator<<(QDataStream &ds, Utils::Id id);
    friend UTILS_LIBRARY_EXPORT QDataStream &operator>>(QDataStream &ds, Utils::Id &id);
    friend UTILS_LIBRARY_EXPORT QDebug operator<<(QDebug dbg, const Utils::Id &id);
